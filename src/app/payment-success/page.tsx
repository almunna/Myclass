...
import { getUserSubscription, createOrUpdateUserSubscription } from "@/lib/db/users";
...
function PaymentSuccessContent() {
    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen p-4" suppressHydrationWarning>
            <div className="max-w-md w-full space-y-8 text-center">
                ...
                {loading ? (
                    ...
                    <div className="bg-gray-50 p-4 rounded-lg text-left">
                        ...
                        <p className="text-sm text-gray-600">Status: <span className="font-medium text-green-600">{subscription.subscriptionStatus}</span></p>
                        <p className="text-sm text-gray-600">Plan: <span className="font-medium">{subscription.subscriptionPlan}</span></p>
