...
export default function ShareClient() {
  ...
  const [copyPeriodId, setCopyPeriodId] = React.useState<string>("");
  ...
  async function copyIntoMyCalendar() {
    ...
    setCopySaving(true);
    try {
      const dstPeriodId = copyPeriodId || "";
    ...
    <div className="p-4 md:p-6">
      <Card className="mb-4">
        ...
        <CardContent className="text-sm text-muted-foreground">
          You can copy a plan into your own calendar.
        </CardContent>
      </Card>
