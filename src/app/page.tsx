...
export default function LandingPage() {
  ...
  const faqs = [
    ...
    {
      question:
        "I have a student that I have in 2 different class periods, can My Class Log accommodate this?",
    ...
    },
    {
      ...
      answer:
        "The only information required is the students' first and last name and what period or periods they are in. Student ID and Grade are optional and are not required.",
    },
    {
      question: "Can a student's ID contain numbers and or text?",
      answer:
        "Yes, the ID can be all numbers, all letters, or a combination of both.",
    },
    {
      question: "How does the attendance tracking feature work?",
      answer:
        "Our attendance system lets you easily mark students as Present, Tardy, or Absent with just a click. You can take attendance for any date, edit past records, and generate detailed reports by date range, period, or individual student. The system automatically saves your data and provides visual summaries.",
    },
    {
      question: "Does my subscription include new features and updates?",
      answer:
        "Updates are included with your subscription. New features may or may not be included. Based on the degree of difficulty and time needed to create a new feature would determine if there were an additional charge.",
    },
  ];
        ...
        <div className="container mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Powerful features designed by teachers, for teachers. Simplify
              your daily workflow.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <Card className="border-2 hover:border-blue-200 transition-colors">
              <CardHeader>
                ...
                <CardDescription>
                  Organize students across multiple school years and periods
            ...
            <Card className="border-2 hover:border-blue-200 transition-colors">
              <CardHeader>
                ...
                <CardDescription>
                  Track when students leave and return with precise timestamps
            ...
            <Card className="border-2 hover:border-blue-200 transition-colors">
              <CardHeader>
                ...
                <CardDescription>
                  Forgot to mark a student back in? Easily edit exit and return
                  times with intuitive controls.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <ul className="space-y-2 text-sm text-gray-600">
            ...
            <Card className="border-2 hover:border-blue-200 transition-colors">
              <CardHeader>
                ...
                <CardDescription>
                  Comprehensive reporting with multi-level filtering by school
                  year, period, and student.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <ul className="space-y-2 text-sm text-gray-600">
            ...
            <Card className="border-2 hover:border-blue-200 transition-colors">
              <CardHeader>
                ...
                <CardDescription>
                  Take daily attendance with ease. Track Present, Tardy, and
                  Absent students with powerful reporting features.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <ul className="space-y-2 text-sm text-gray-600">
            ...
            <Card className="border-2 hover:border-blue-200 transition-colors">
              <CardHeader>
                ...
                <CardDescription>
                  Organize with school years at the top level, containing class
                  periods for complete structure.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <ul className="space-y-2 text-sm text-gray-600">
            ...
            <Card className="border-2 hover:border-blue-200 transition-colors">
              <CardHeader>
                ...
                <CardTitle>Class Layout</CardTitle>
                <CardDescription>
                  Design and save seating charts, drag & drop students, and
                  manage layouts per period.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <ul className="space-y-2 text-sm text-gray-600">
                  ...
                  <li className="flex items-center">
                    <CheckCircle className="h-4 w-4 text-green-500 mr-2" />
                    Save multiple layouts per class
                  </li>
                  <li className="flex items-center">
                    <CheckCircle className="h-4 w-4 text-green-500 mr-2" />
                    Quick shuffle (random/name/gender)
                  </li>
                </ul>
              </CardContent>
            </Card>
            ...
            <Card className="border-2 hover:border-blue-200 transition-colors">
              <CardHeader>
                ...
                <CardDescription>
                  Log positive/negative behaviors, add notes and actions, and
                  export detailed histories.
                </CardDescription>
              </CardHeader>
              <CardContent>
                <ul className="space-y-2 text-sm text-gray-600">
                  <li className="flex items-center">
                    <CheckCircle className="h-4 w-4 text-green-500 mr-2" />
                    Quick logging with custom lists
                  </li>
                  <li className="flex items-center">
                    <CheckCircle className="h-4 w-4 text-green-500 mr-2" />
                    Filter by date, type, behavior, action
                  </li>
                  <li className="flex items-center">
                    <CheckCircle className="h-4 w-4 text-green-500 mr-2" />
        ...
        <div className="container mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-blue-100 max-w-2xl mx-auto">
              Join other educators who have transformed their classroom
              management
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-blue-100">
                Reduce administrative tasks by 70%. Spend more time teaching,
            ...
            <div className="text-center">
              ...
              <p className="text-blue-100">
                Understand student patterns and behaviors with detailed
            ...
            <div className="text-center">
              ...
              <p className="text-blue-100">
                Keep all student data secure, organized, and easily accessible
                from anywhere.
              </p>
            </div>
          </div>
        ...
        <div className="container mx-auto text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xl text-gray-600 mb-8">
              Join other teachers who are already saving time and staying
              organized with MyClassLog.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              {currentUser ? (
                <Link href="/dashboard">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex flex-wrap gap-4 justify-center md:justify-end text-sm text-gray-400">
              ...
              <span className="w-full md:w-auto text-center md:text-left">
                © 2024 MyClassLog. All rights reserved.
              </span>
            </div>
          </div>
        </div>
