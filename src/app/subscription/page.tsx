...
import { CheckCircle, Calendar, CreditCard, AlertCircle, Check, Star, Zap, Crown, Shield, Trophy, Sparkles, ArrowLeft } from 'lucide-react';
...
const pricingPlans = [
  ...
  },
  {
    name: "Annual Pro",
    price: 7.99,
    description: "Best value plan with significant savings for committed educators.",
    features: [
        ...
        return (
            <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 flex justify-center items-center">
                <div className="text-center">
                    ...
                    <p className="text-slate-600 font-medium">Loading your subscription...</p>
                </div>
            </div>
        );
    }
                            ...
                            <div className="lg:col-span-2">
                                <Card className="relative overflow-hidden shadow-2xl border-0">
                                    ...
                                    <div className="bg-gradient-to-r from-emerald-500 to-green-600 p-8 text-white relative">
                                        ...
                                        <h2 className="text-3xl font-bold mb-2">Active Subscription</h2>
                                        <p className="text-green-100 text-lg">
                                            You have an active <span className="font-bold capitalize">{subscription.subscriptionPlan}</span> plan
                                        </p>
                                    </div>
                                        ...
                                        <div className="grid md:grid-cols-2 gap-6">
                                            <div className="space-y-4">
                                                <div className="flex items-center justify-between p-4 bg-slate-50 rounded-xl">
                                                    ...
                                                    <span className="font-bold text-slate-900 capitalize">{subscription.subscriptionPlan}</span>
                                </div>
                                ...
                                {subscription.subscriptionEndDate && (
                                            ...
                                            {subscription.subscriptionEndDate.toDate 
                                                ...
                                                ? new Date(subscription.subscriptionEndDate.seconds * 1000).toLocaleDateString()
                            ...
                            <div className="space-y-6">
                                <Card className="shadow-lg border-0 bg-gradient-to-br from-blue-50 to-indigo-100">
                                    ...
                                    <CardContent className="space-y-3">
                                        {["Unlimited students", "Advanced tracking", "Detailed reports", "CSV exports", "Multi-class support", "Priority support"].map((benefit, index) => (
                                ...
                                <Card className="shadow-lg border-0 bg-gradient-to-br from-emerald-50 to-green-100">
                                    ...
                                    <CardContent className="space-y-3 text-sm text-slate-600">
                                        <p>Your subscription is secured with industry-standard encryption and can be cancelled at any time.</p>
                    ...
                    <AlertDialogContent className="max-w-md">
                        <AlertDialogHeader className="text-center">
                            ...
                            <AlertDialogDescription className="text-slate-600">
                                You'll lose access to premium features after your current billing period ends. Your data will be preserved, but advanced features will be disabled.
                                </AlertDialogDescription>
                            </AlertDialogHeader>
                        <AlertDialogFooter className="flex flex-col gap-3 sm:flex-row">
                            <AlertDialogCancel className="flex-1">Keep My Subscription</AlertDialogCancel>
                                <AlertDialogAction 
                    ...
                    <div className="max-w-6xl mx-auto px-4 py-6">
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-xl text-slate-600">
                                You're subscribing to the <span className="font-semibold text-blue-600">{selectedPlan.name}</span> plan
                        </p>
                        </div>
                    </div>
                    </div>
                            ...
                            <Card className="shadow-2xl border-0 sticky top-8">
                                <div className={`bg-gradient-to-r ${selectedPlan.gradient} p-6 text-white relative overflow-hidden`}>
                                    ...
                                    <div className="flex items-baseline gap-2">
                                        ...
                                        <span className="text-white/80 text-lg">/{selectedPlan.interval}</span>
                        ...
                        {/* Payment Form */}
                            <Card className="shadow-2xl border-0">
                                <CardHeader className="pb-6">
                                    <CardTitle className="text-2xl text-slate-900">Payment Details</CardTitle>
                ...
                <div className="relative py-24 px-4">
                    <div className="max-w-6xl mx-auto text-center text-white">
                        ...
                        <p className="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto mb-8">
                            Select the perfect plan for your student tracking needs. Upgrade, downgrade, or cancel at any time with our flexible billing.
                    </p>
                    </div>
                </div>
                </div>
                 ...
                 <div className="max-w-6xl mx-auto">
                     <div className="grid lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
                        {pricingPlans.map((plan, index) => (
                             <div key={index} className={`relative ${plan.popular ? 'pt-6' : ''}`}>
                                 {plan.popular && (
                            ...
                            <Card 
                                ...
                                {/* Header */}
                                <div className={`bg-gradient-to-r ${plan.gradient} p-8 text-white relative`}>
                                    <div className="absolute top-0 right-0 p-6">
                                        <div className="w-16 h-16 bg-white/20 rounded-full flex items-center justify-center">
                                        {plan.icon}
                                        </div>
                                    ...
                                    <div className="flex items-baseline gap-2">
                                        ...
                                        <span className="text-white/80 text-lg">/{plan.interval}</span>
                                        {plan.savings && (
                    ...
                    <div className="text-center mt-16">
                        <div className="bg-white rounded-2xl shadow-lg p-8 max-w-4xl mx-auto">
                            <h3 className="text-2xl font-bold text-slate-900 mb-6">Why Choose MyClassLog?</h3>
                            <div className="grid md:grid-cols-3 gap-6">
                                ...
                                <div className="text-center">
                                    ...
                                    <h4 className="font-semibold text-slate-800 mb-2">Secure Payments</h4>
                                    <p className="text-sm text-slate-600">Bank-level security with encrypted transactions</p>
                                </div>
                                <div className="text-center">
                                    <div className="w-12 h-12 bg-purple-100 rounded-full flex items-center justify-center mx-auto mb-3">
                                        <Sparkles className="h-6 w-6 text-purple-600" />
                                    </div>
                                    <h4 className="font-semibold text-slate-800 mb-2">Cancel Anytime</h4>
                                    <p className="text-sm text-slate-600">No long-term commitments or hidden fees</p>
                                </div>
                    </div>
                </div>
                    </div>
