        ...
        <div className="container mx-auto text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-2xl mx-auto leading-relaxed">
              Choose the plan that works for you. All plans include unlimited students, 
              periods, and comprehensive reporting features.
            </p>
          ...
          <div className="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <Card className="border-2 border-gray-200 hover:border-blue-300 transition-colors">
              <CardHeader className="text-center">
                ...
                <div className="text-4xl font-bold text-gray-900 mt-6">$1.50</div>
              ...
              <CardContent>
                <ul className="space-y-4 mb-8">
                  ...
                  <li className="flex items-center">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-3 flex-shrink-0" />
                    <span className="text-gray-700">Unlimited periods & school years</span>
                  </li>
                  <li className="flex items-center">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-3 flex-shrink-0" />
                    <span className="text-gray-700">Advanced room exit tracking</span>
                  </li>
                  <li className="flex items-center">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-3 flex-shrink-0" />
                  ...
                  <li className="flex items-center">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-3 flex-shrink-0" />
                    <span className="text-gray-700">Multi-class management</span>
                  </li>
                  <li className="flex items-center">
                    <CheckCircle className="h-5 w-5 text-green-500 mr-3 flex-shrink-0" />
            ...
            <Card className="border-2 border-blue-500 relative hover:border-blue-600 transition-colors">
              ...
              <CardHeader className="text-center">
                ...
                <CardDescription className="text-lg">Save money with yearly billing</CardDescription>
                <div className="text-4xl font-bold text-gray-900 mt-6">$7.99</div>
